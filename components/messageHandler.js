...
//     if (isGroup && !text.startsWith(PREFIX) && !['sticker', 'menu', 'image', 'video', 'analyze', 'jolie', 'musique', 'online', 'stat','catalogue','produit1','produit2','produit3',,'produit4','produit5'].includes(text.split(' ')[0]) && !msg.message.audioMessage && !isMentioned && !isQuotedBot) {
...
export async function handleMessages(sock, msg, botJid) {
  try {
    ...
    if (isGroup && !text.startsWith(PREFIX) && !['sticker', 'menu', 'image', 'video', '@', 'jolie', 'musique', 'online', 'stat','catalogue','produit1','produit2','produit3',,'produit4','produit5'].includes(text.split(' ')[0]) && !msg.message.audioMessage && !isMentioned && !isQuotedBot) {
      console.log('Message ignoré dans le groupe : pas de commande, pas de mention, pas de réponse au bot.');
      return;
    }
